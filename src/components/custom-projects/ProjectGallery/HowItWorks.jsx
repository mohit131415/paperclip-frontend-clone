    ...
    return (
      <section className="grid md:grid-cols-2 mb-5 border border-black!">
        ...
        <div className="relative h-[500px]">
          <img
            src="https://www.paperclipstore.in/cdn/shop/files/Custom_Projects_Master01.jpg?v=1719082828&width=642"
        ...
        <div className="bg-black text-white p-8 md:p-12 lg:p-16 flex flex-col justify-center">
          ...
          <button className="bg-white text-black px-8 py-3 text-sm font-medium hover:bg-gray-100 transition-colors w-fit">
            <a href="/contact">
